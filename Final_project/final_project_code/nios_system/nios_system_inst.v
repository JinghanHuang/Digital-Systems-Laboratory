	nios_system u0 (
		...
		.player_1_x_pos_export  (<connected-to-player_1_x_pos_export>),  //  player_1_x_pos.export
		.player_1_y_pos_export  (<connected-to-player_1_y_pos_export>)   //  player_1_y_pos.export
	);
